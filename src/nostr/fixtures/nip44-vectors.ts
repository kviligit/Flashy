/**
 * Official NIP-44 v2 test vectors, from paulmillr/nip44 (the collection the
 * NIP itself links to as the reference).
 *
 * Committed as TypeScript because the build is a bare `tsc` with no step
 * that copies data files into the output.
 */
...
export const NIP44_VECTORS = {
  ...
  "messageKeys": {
    "conversationKey": "a1a3d60f3470a8612633924e91febf96dc5366ce130f658b1f0fc652c20b3b54",
    "keys": [
      {
